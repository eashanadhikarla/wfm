...
do
	...
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s7.ipcamlive.com/streams/075f71bc91c35b4bb/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==38{print $1}' webcam-list.csv)/punta_fishermen_$N.png # https://kingfisherfleet.com/live-cam/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s57.ipcamlive.com/streams/395f78f939ddd6c73/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==38{print $1}' webcam-list.csv)/ocean_city_broadwalk_$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-boardwalk-shark-eye-cam/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s33.ipcamlive.com/streams/215f77978a72855d9/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==39{print $1}' webcam-list.csv)/ocean_city_MD_broadwalk2_$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-md-boardwalk-cam-2/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s6.ipcamlive.com/streams/065f671aea23aab88/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==40{print $1}' webcam-list.csv)/thrashers_fries_$N.png # https://oceancitylive.com/ocean-city-webcams/thrashers-french-fries/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s11.ipcamlive.com/streams/0b5f5c8336df31271/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==41{print $1}' webcam-list.csv)/ocean_city_amusements_$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-md-amusements-pier-cam/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s11.ipcamlive.com/streams/0b5f621607ea16662/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==42{print $1}' webcam-list.csv)/castle_sand_$N.png # https://oceancitylive.com/ocean-city-webcams/castle-in-the-sand/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s47.ipcamlive.com/streams/2f5f78d218ac8c848/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==43{print $1}' webcam-list.csv)/mackys_bayside_$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-boardwalk-cam/
	
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s50.ipcamlive.com/streams/325f77221ac757018/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==47{print $1}' webcam-list.csv)/maryland_broadwalk_$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-maryland-boardwalk-audio-cam/
	# ffmpeg -loglevel warning -hide_banner -stats -i 'https://s50.ipcamlive.com/streams/325f77221ac757018/snapshot.jpg' -frames:v 1 $(awk -F "," 'NR==62{print $1}' webcam-list.csv)/maryland_broadwalk__$N.png # https://oceancitylive.com/ocean-city-webcams/ocean-city-maryland-boardwalk-audio-cam/
